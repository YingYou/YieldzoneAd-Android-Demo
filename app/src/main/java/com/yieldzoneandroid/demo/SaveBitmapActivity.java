...
import com.yieldzone.baselibrary.cache.CacheDiskUtils;
...
public class SaveBitmapActivity extends Activity {
	...
	public static void start(Context context) {
		context.startActivity(new Intent(context, com.yieldzoneandroid.demo.SaveBitmapActivity.class));
	}
	...
	public void save(View v) {
		...
		//mCache.put("testBitmap", bitmap, 10);
		CacheDiskUtils.getInstance().put("testBitmap", bitmap, 10);
	}
	...
	public void read(View v) {
		...
		Bitmap testBitmap = CacheDiskUtils.getInstance().getBitmap("testBitmap");
		if (testBitmap == null) {
	...
	public void clear(View v) {
		...
		CacheDiskUtils.getInstance().remove("testBitmap");
	}
}
